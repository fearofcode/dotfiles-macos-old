...
** Linear algebra books already owned
** Real analysis, complex analysis
** Fourier Analysis And Its Applications
** Fourier Analysis: An Introduction (blue book already owned)
** All the other math books in cart and on shelf that are relevant
...
** 6.02: Intro EECS 2
*** Just go with material at https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-02-introduction-to-eecs-ii-digital-communication-systems-fall-2012/index.htm
** 6.002: Circuits
...
** 6.003: Signals and Systems (maybe)
...
** Later: control classes from course 2
