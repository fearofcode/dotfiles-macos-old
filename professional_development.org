...
** Core Java
** [[https://docs.oracle.com/javase/tutorial/displayCode.html?code%3Dhttps://docs.oracle.com/javase/tutorial/uiswing/examples/concurrency/FlipperProject/src/concurrency/Flipper.java][SwingWorker example]]
** [[https://netbeans.org/kb/docs/java/quickstart-gui.html][Designing a Swing GUI in Netbeans]]
** [[https://docs.oracle.com/javase/tutorial/2d/][Java 2D graphics]]
** [[http://www.jfree.org/jfreechart/][JFreeChart]]
** [[http://www.object-refinery.com/orsoncharts/][Orson Charts (3D)]]
...
** AI Application programming: fuzzy control example, Q learning example. Alternatives?
** [[https://jogamp.org/wiki/index.php/Downloading_and_installing_JOGL][Downloading and installing JOGL]] (not strictly necessary, 2d examples will work without this)
