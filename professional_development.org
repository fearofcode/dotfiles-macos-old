...
** TODO Autotools book
** TODO Understand and comprehend Linus Torvalds' double pointer comment
...
* Assembly language, UNIX systems programming, machine organization, concurrency [0/15]
...
** TODO Computer Systems: A Programmer's Perspectiv
** TODO Discovering Modern C++ -> C++ Concurrency In Action: Practical Multithreading
** TODO Read-only Twitter client in C++				    :project:
